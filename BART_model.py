...
def get_vectorstore(texts):
    embeddings = HuggingFaceInstructEmbeddings(model_name="facebook/bart-large-cnn")
    all_chunks = []
...
def get_conversation_chain(vectorstore):
    llm = HuggingFaceHub(repo_id="facebook/bart-large-cnn", model_kwargs={"temperature": 0.5, "max_length": 2048})
